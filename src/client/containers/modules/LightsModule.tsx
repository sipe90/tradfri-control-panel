...
const LightsModule: React.FC = () => {
    ...
    const groups = useSelector<IAppState, Dictionary<IGroup>>((state) => state.entities.groups)
    const lights = useSelector<IAppState, Dictionary<ILight>>((state) => state.entities.lights)
    const circadianSettings = useSelector<IAppState, ICircadianSettings>((state) => state.entities.settings.circadian)
